...
const SettingsModal: React.FC<SettingsModalProps> = ({ isOpen, onClose }) => {
  const { theme, toggleTheme, defaultFederation, setDefaultFederation } = useTheme();
      ...
      <div className="bg-slate-900 dark:bg-slate-900 bg-white border border-slate-800 dark:border-slate-800 border-slate-200 rounded-3xl p-8 max-w-md w-full mx-4 shadow-2xl" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-4 p-4 bg-slate-950 dark:bg-slate-950 bg-slate-50 border border-slate-800 dark:border-slate-800 border-slate-200 rounded-xl">
              <span className="text-sm text-slate-400 dark:text-slate-400 text-slate-600 flex-1">Theme</span>
              <button
                onClick={toggleTheme}
              ...
              <span className="text-sm text-slate-300 dark:text-slate-300 text-slate-700 w-16 text-right">
