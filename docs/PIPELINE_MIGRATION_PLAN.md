...
Already in the GCP ecosystem (Firebase project `prepsuite-acfb8`). Cloud Run is the natural fit:
...
- UI rendering (React SPA, Firebase Hosting)
...
- Negligible compared to existing Supabase + Firebase costs
